...
/** Excecutes an action for this FSM node. The action must be
 *  valid for the given state. Othervise an error will be issued
 *  @param[in] action The action to excecute.
 *  @return FSM_RET_SUCCESS if the action was excecuted successfully, othervise FSM_RET_ERROR */
int 
...
/** Excecutes an action for a spesific FSM node. The action must be
*  valid for the given state. Othervise an error will be issued
