...
{
    LGeneratorLoggingSystemTests::LGeneratorLoggingSystemTests(const string path, const string classname,  const LXMLInfo xmlinfo, const bool add_suffix) : LGenerator(path, classname,  xmlinfo, add_suffix)
    {
    }
