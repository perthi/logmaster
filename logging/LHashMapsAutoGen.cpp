...
//    eLOGLEVEL level = (eLOGLEVEL)(PAD((int)l));
   ...
   void
   LHashMapsAutoGen::InitPermissions( )
   {
       fPermissions.emplace(eMSGSYSTEM::SYS_EXCEPTION, false);
       fPermissions.emplace(eMSGSYSTEM::SYS_ALARM, false);
       fPermissions.emplace(eMSGSYSTEM::SYS_FSM, true);
   ...
   bool    
   IsChangeable(const eMSGSYSTEM system)
   {
