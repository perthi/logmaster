...
TEST_F(TestHashMapsAutoGenerated, contains_enums)
{
    ...
    EXPECT_TRUE(g_utilities()->Contains(systems,eMSGSYSTEM::SYS_MEASUREMENT));
    EXPECT_TRUE(g_utilities()->Contains(systems,eMSGSYSTEM::SYS_CLI));
    EXPECT_TRUE(g_utilities()->Contains(systems,eMSGSYSTEM::SYS_FOC));
...
TEST_F(TestHashMapsAutoGenerated, is_subcmd)
{
    ...
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--measurement-fatal"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--measurement-error"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--measurement-warning"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--measurement-info"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--measurement-debug"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--measurement-force_debug"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--meas-fatal"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--meas-error"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--meas-warning"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--meas-info"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--meas-debug"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--meas-force_debug"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--cli-fatal"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--cli-error"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--cli-warning"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--cli-info"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--cli-debug"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--cli-force_debug"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--foc-fatal"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--foc-error"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--foc-warning"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--foc-info"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--foc-debug"));
    EXPECT_TRUE(LHashMaps::IsSubCmdHash("--foc-force_debug"));
