...
{
     EXPECT_EQ( eLOGLEVEL::LOG_FORCE_DEBUG, LConversion::String2Level( "001000000000000000000000" ) );
     ...
     EXPECT_EQ( eLOGLEVEL::LOG_OFF,         LConversion::String2Level( "000000000000000000100000" ) );
     EXPECT_EQ( eLOGLEVEL::LOG_ALL,         LConversion::String2Level( "111111110000000001000000" ) );


/** @todo this test should be auto-generated from  the XML file */    
//     EXPECT_EQ( PAD( eLOGLEVEL::LOG_ERROR ),        (int)LConversion::String2Level( "--ana-error" ) );
//     EXPECT_EQ( PAD( eLOGLEVEL::LOG_WARNING ),    (int)LConversion::String2Level( "--data-warning" ) );
//     EXPECT_EQ( PAD( eLOGLEVEL::LOG_DEBUG ),     (int)LConversion::String2Level( "--ex-debug" ) );
//     EXPECT_EQ( PAD( eLOGLEVEL::LOG_ERROR ),        (int)LConversion::String2Level( "--driver-error" ) );
...
//     EXPECT_EQ( PAD( eLOGLEVEL::LOG_WARNING ),   (int)LConversion::String2Level( "--db-gen-warning" ) );
//     EXPECT_EQ( PAD( eLOGLEVEL::LOG_WARNING ),   (int)LConversion::String2Level( "--db-sql-warning" ) );
//     EXPECT_EQ( PAD( eLOGLEVEL::LOG_INFO ),        (int)LConversion::String2Level( "--db-report-info" ) );
//     EXPECT_EQ( PAD( eLOGLEVEL::LOG_INFO ),        (int)LConversion::String2Level( "--db-info" ) );
//     EXPECT_EQ( PAD( eLOGLEVEL::LOG_INFO ),        (int)LConversion::String2Level( "--db-gen-info" ) );
//     EXPECT_EQ( PAD( eLOGLEVEL::LOG_ERROR ),     (int)LConversion::String2Level( "--all-error" ) );    
}
...
{                                                                   
    EXPECT_EQ( eLOGLEVEL::LOG_FORCE_DEBUG, LConversion::Instance()->BinaryString2Level( "001000000000000000000000" ) );
    EXPECT_EQ( eLOGLEVEL::LOG_DEBUG,       LConversion::Instance()->BinaryString2Level( "000100000000000000000001" ) );
    EXPECT_EQ( eLOGLEVEL::LOG_INFO,        LConversion::Instance()->BinaryString2Level( "000010000000000000000010" ) );
    EXPECT_EQ( eLOGLEVEL::LOG_WARNING,     LConversion::Instance()->BinaryString2Level( "000001000000000000000100" ) );
    EXPECT_EQ( eLOGLEVEL::LOG_ERROR,       LConversion::Instance()->BinaryString2Level( "000000100000000000001000" ) );
    EXPECT_EQ( eLOGLEVEL::LOG_FATAL,       LConversion::Instance()->BinaryString2Level( "000000010000000000010000" ) );
    EXPECT_EQ( eLOGLEVEL::LOG_OFF,         LConversion::Instance()->BinaryString2Level( "000000000000000000100000" ) );
    EXPECT_EQ( eLOGLEVEL::LOG_ALL,         LConversion::Instance()->BinaryString2Level( "111111110000000001000000" ) );
    eLOGLEVEL combo = eLOGLEVEL::LOG_DEBUG | eLOGLEVEL::LOG_WARNING;
...
/** @todo this test should be autogenerated form the XML file */
...
/** @todo this test should be auto-generated form the XML file */
// TEST_F( TestLConversion, Hash2Level )
// {
//     EXPECT_EQ( PAD(eLOGLEVEL::LOG_FATAL),      (int)LConversion::Hash2Level( "--ana-fatal"  ) );
//     EXPECT_EQ( PAD(eLOGLEVEL::LOG_WARNING),    (int)LConversion::Hash2Level( "--data-warning"  ) );
//     EXPECT_EQ( PAD(eLOGLEVEL::LOG_DEBUG),      (int)LConversion::Hash2Level( "--ex-debug"  ) );
//     EXPECT_EQ( PAD(eLOGLEVEL::LOG_ALL),        (int)LConversion::Hash2Level( "--driver-all"  ) );
//     EXPECT_EQ( PAD(eLOGLEVEL::LOG_OFF),        (int)LConversion::Hash2Level( "--user-off"  ) );
...
//     EXPECT_EQ( PAD(eLOGLEVEL::LOG_FATAL),      (int)LConversion::Hash2Level( "--db-sql-fatal"  ) );
//     EXPECT_EQ( PAD(eLOGLEVEL::LOG_INFO),       (int)LConversion::Hash2Level( "--db-report-info"  ) );
