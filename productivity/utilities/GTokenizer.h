...
private:
     vector<string>   API   Tokenize(const vector<string> &source, const string sep = "\t", const  bool keep_empty = DISCARD_EMPTY, const bool keep_sep = DISCAR_SEPARATOR, const bool keep_front = false);
};
